// AnimBlueprintGeneratedClass ABP_ch0800_st.ABP_ch0800_st_C
// Size: 0x808 (Inherited: 0x280)
struct UABP_ch0800_st_C : URSStaticEventCharaAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_ch0800_st.ABP_ch0800_st_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void ExecuteUbergraph_ABP_ch0800_st(int32_t EntryPoint); // Function ABP_ch0800_st.ABP_ch0800_st_C.ExecuteUbergraph_ABP_ch0800_st // (Final|UbergraphFunction) // @ game+0x1685580
};
