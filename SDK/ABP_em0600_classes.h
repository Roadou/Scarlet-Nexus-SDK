// AnimBlueprintGeneratedClass ABP_em0600.ABP_em0600_C
// Size: 0x1260 (Inherited: 0x710)
struct UABP_em0600_C : URSEnemyAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_em0600.ABP_em0600_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void DownCheck(); // Function ABP_em0600.ABP_em0600_C.DownCheck // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function ABP_em0600.ABP_em0600_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1685580
	void ExecuteUbergraph_ABP_em0600(int32_t EntryPoint); // Function ABP_em0600.ABP_em0600_C.ExecuteUbergraph_ABP_em0600 // (Final|UbergraphFunction) // @ game+0x1685580
};
