...
struct UABP_Ajito_ch0700_C : URSAjitoAnimInstance {
	...
	bool __CustomProperty_bKawaiiPhysics_1F3568CF4880001674AD788F075B3D54; // 0xd80(0x01)
	char pad_D81[0x3]; // 0xd81(0x03)
	float __CustomProperty_PhysicsIdlingSec_1F3568CF4880001674AD788F075B3D54; // 0xd84(0x04)
	float __CustomProperty_PhysicsAlpha_1F3568CF4880001674AD788F075B3D54; // 0xd88(0x04)
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Ajito_ch0700.ABP_Ajito_ch0700_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void InitializeFromParentActor(); // Function ABP_Ajito_ch0700.ABP_Ajito_ch0700_C.InitializeFromParentActor // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void BlueprintInitializeAnimation(); // Function ABP_Ajito_ch0700.ABP_Ajito_ch0700_C.BlueprintInitializeAnimation // (Event|Public|BlueprintEvent) // @ game+0x1685580
	void ExecuteUbergraph_ABP_Ajito_ch0700(int32_t EntryPoint); // Function ABP_Ajito_ch0700.ABP_Ajito_ch0700_C.ExecuteUbergraph_ABP_Ajito_ch0700 // (Final|UbergraphFunction) // @ game+0x1685580
};
