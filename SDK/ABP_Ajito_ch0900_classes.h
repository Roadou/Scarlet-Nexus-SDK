...
struct UABP_Ajito_ch0900_C : URSAjitoAnimInstance {
	...
	bool __CustomProperty_bKawaiiPhysics_845B0E514E9E49B037E728BFF7235C36; // 0xd80(0x01)
	char pad_D81[0x3]; // 0xd81(0x03)
	float __CustomProperty_PhysicsIdlingSec_845B0E514E9E49B037E728BFF7235C36; // 0xd84(0x04)
	float __CustomProperty_PhysicsAlpha_845B0E514E9E49B037E728BFF7235C36; // 0xd88(0x04)
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Ajito_ch0900.ABP_Ajito_ch0900_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void InitializeFromParentActor(); // Function ABP_Ajito_ch0900.ABP_Ajito_ch0900_C.InitializeFromParentActor // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void BlueprintInitializeAnimation(); // Function ABP_Ajito_ch0900.ABP_Ajito_ch0900_C.BlueprintInitializeAnimation // (Event|Public|BlueprintEvent) // @ game+0x1685580
	void ExecuteUbergraph_ABP_Ajito_ch0900(int32_t EntryPoint); // Function ABP_Ajito_ch0900.ABP_Ajito_ch0900_C.ExecuteUbergraph_ABP_Ajito_ch0900 // (Final|UbergraphFunction) // @ game+0x1685580
};
