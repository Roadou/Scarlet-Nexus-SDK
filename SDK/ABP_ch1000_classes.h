// AnimBlueprintGeneratedClass ABP_ch1000.ABP_ch1000_C
// Size: 0x2048 (Inherited: 0x820)
struct UABP_ch1000_C : URSPlayerAnimInstance {
	...
	struct FAnimNode_ModifyBone AnimGraphNode_ModifyBone; // 0x1038(0x108)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace; // 0x1140(0x20)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace; // 0x1160(0x20)
	...
	bool __CustomProperty_bKawaiiPhysics_B402FF844B9E158BA84FC0BE51AA061C; // 0x1df0(0x01)
	char pad_1DF1[0x3]; // 0x1df1(0x03)
	float __CustomProperty_PhysicsIdlingSec_B402FF844B9E158BA84FC0BE51AA061C; // 0x1df4(0x04)
	float __CustomProperty_PhysicsAlpha_B402FF844B9E158BA84FC0BE51AA061C; // 0x1df8(0x04)
	char pad_1DFC[0x4]; // 0x1dfc(0x04)
	struct FAnimNode_LinkedAnimGraph AnimGraphNode_SubInstance; // 0x1e00(0xa0)
	struct FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose; // 0x1ea0(0xb8)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_2; // 0x1f58(0x28)
	struct FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose; // 0x1f80(0x28)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool; // 0x1fa8(0xa0)

	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_ch1000.ABP_ch1000_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void ExecuteUbergraph_ABP_ch1000(int32_t EntryPoint); // Function ABP_ch1000.ABP_ch1000_C.ExecuteUbergraph_ABP_ch1000 // (Final|UbergraphFunction) // @ game+0x1685580
};
