// AnimBlueprintGeneratedClass ABP_em0760.ABP_em0760_C
// Size: 0x1321 (Inherited: 0x710)
struct UABP_em0760_C : URSEnemyAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_em0760.ABP_em0760_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void DownCheck(); // Function ABP_em0760.ABP_em0760_C.DownCheck // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1685580
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function ABP_em0760.ABP_em0760_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1685580
	void ExecuteUbergraph_ABP_em0760(int32_t EntryPoint); // Function ABP_em0760.ABP_em0760_C.ExecuteUbergraph_ABP_em0760 // (Final|UbergraphFunction) // @ game+0x1685580
};
